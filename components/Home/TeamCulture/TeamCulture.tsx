  ...
  return (
    <>
      ...
      >
        ...
        <BackgroundGradientBlur className="top-40 left-0" />
        <BackgroundGradientBlur className="top-600 right-0" />
        {/* 1 */}
        <div className="flex justify-between items-center mb-20 z-20">
          <h2 className="text-left mb-5  ">
            <div className="mb-4">
              <span className="font-normal text-3xl md:text-5xl bg-line">
                CULTURE
              </span>
            </div>
        ...
        {/* 2 */}
        <div className="text-right flex flex-col items-center mb-28">
          <div className="w-40 h-1 bg-[#687318] rounded-sm mb-7"></div>
          <Paragraph className={`max-w-[600px] text-center text-xl`}>
        ...
        <div className="flex justify-evenly items-center mb-20 z-20">
            ...
            <Image
              src="/what-happened-on-friday.png"
              width={363}
              height={382}
              className="max-w-[490px] h-auto"
              alt="simple but ambitious section cover"
